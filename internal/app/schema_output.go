...
func OutputSchema(name string) map[string]any {
	...
	case "browser_session":
		...
		props["backend"] = stringProp("Active browser backend.")
		props["cdp_url"] = stringProp("CDP endpoint for attached or AgentDock-owned CDP sessions.")
		props["browser_ownership"] = stringProp("Browser ownership for CDP sessions: attached for external browsers or owned for AgentDock-launched browsers.")
	...
	case "browser_act", "browser_snapshot":
		...
		props["storage_state_path"] = stringProp("Saved browser storage state path when requested.")
